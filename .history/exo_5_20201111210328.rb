...
=begin 46.to_s(26).tr( "0123456789abcdefghijklmnopq", "abcdefghijklmnopqrstuvwxyz" )
=> "bu"

"bu".tr( "abcdefghijklmnopqrstuvwxyz", "0123456789abcdefghijklmnopq" ).to_i(26) =end

# On affiche une question à l'utilisateur :
puts "entrez un mot ou une phrace:"
# on créer une variable strthing
strthing=[ ]
strthing = strthing.chomp.to_s
